...
public class ProgressManager {
    ...
    private void checkActivityAchievements() {
        ...
        if (activities.getOrDefault("typing_practice", 0) >= 3 &&
                !getAchievements().contains("fast_typer")) {
            unlockAchievement("fast_typer");
        }

        if (activities.getOrDefault("drag_drop", 0) >= 3 &&
                !getAchievements().contains("puzzle_solver")) {
    ...
    private String getAchievementName(String achievementId) {
        switch (achievementId) {
            ...
            case "fast_typer": return "Fast Typer!";
            case "puzzle_solver": return "Puzzle Solver!";
